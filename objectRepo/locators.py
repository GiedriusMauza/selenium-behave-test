...
class Home:
    new_account_tab = Locator( By.XPATH,
                               "//a[@title='Accounts']//following-sibling::one-app-nav-bar-item-dropdown//*[name()='svg']" )
    NewAccount = Locator( By.XPATH, "//span[text()='New Account']" )
    account_name_txtbox_new_account_window = Locator( By.XPATH,
                                                      "//span[text()='Account Name']//parent::label//following-sibling::div//input" )
    salesforce_save_btn_NewAccountWindow = Locator( By.XPATH, "//button[@title='Save']" )
    salesforce_name_of_new_account = Locator( By.XPATH,
                                              "//slot[@name='primaryField']//div//span[contains(text(),'ObjectToken')]" )
    dynamic_text = Locator( By.XPATH, "(//*[text()='ObjectToken'])[1]" )
    primitive_icon = Locator( By.XPATH,
                              "(//a[@title='ObjectToken']/parent::span/parent::th/following-sibling::td[3]//lightning-primitive-icon)[1]" )
